...
const Lyrics = props => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://cors-anywhere.herokuapp.com/http://api.musixmatch.com/ws/1.1/track.lyrics.get?track_id=${props.match.params.id}&apikey=61e9129a4883c3d5ee0d5153a7adfa2c`
      )
      .then(res => {
        ...
        return axios.get(
          `https://cors-anywhere.herokuapp.com/http://api.musixmatch.com/ws/1.1/track.get?track_id=${props.match.params.id}&apikey=61e9129a4883c3d5ee0d5153a7adfa2c`
        );
      })
      .then(res => {
